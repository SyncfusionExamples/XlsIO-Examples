...
FileStream excelStream = new FileStream(Path.GetFullPath(@"Data/Sample.xlsx"), FileMode.Open, FileAccess.Read);
...
try
{
    ...
    //Create file stream to save the output Image
    FileStream outStream = File.Create("Output.jpeg");
