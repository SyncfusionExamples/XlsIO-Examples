    ...
    public sealed partial class MainPage : Page
    {
		...
		async void OnButtonClicked(object sender, RoutedEventArgs e)
        {
			...
			using (ExcelEngine excelEngine = new ExcelEngine())
			{
				...
				Stream inputStream = executingAssembly.GetManifestResourceStream("Create_Excel.AdventureCycles-Logo.png");
				...
				if (!(Windows.Foundation.Metadata.ApiInformation.IsTypePresent("Windows.Phone.UI.Input.HardwareButtons")))
				{
					...
					savePicker.SuggestedFileName = "Create Excel";
				...
				else
				{
					...
					storageFile = await local.CreateFileAsync("Create Excel.xlsx", CreationCollisionOption.ReplaceExisting);
				}
				//Saving the workbook
