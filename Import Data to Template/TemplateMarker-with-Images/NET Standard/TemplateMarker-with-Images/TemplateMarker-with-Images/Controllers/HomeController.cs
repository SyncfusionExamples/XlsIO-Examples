...
using TemplateMarker_with_Images.Models;

namespace TemplateMarker_with_Images.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult TemplateMarker_with_Images()
        {
            ...
            using (ExcelEngine excelEngine = new ExcelEngine())
            {
                ...
                FileStream excelStream = new FileStream("Data/TemplateMarkerFormatting.xlsx", FileMode.Open, FileAccess.Read);
