# How to remove conditional formatting at the specified index in the worksheet?
...
Step 5: Include the below code snippet in **Program.cs** to remove conditional formatting at the specified index in the worksheet.
{% tabs %}
{% highlight c# tabtitle="C#" %}
